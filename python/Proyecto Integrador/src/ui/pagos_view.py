...
Los pagos se generan automaticamente cuando un cliente reserva un turno
(ver ui/turnos_cliente_view.py, que dispara el pago de prueba en el momento
de la reserva). El administrador no carga pagos a mano: desde aca solo
puede consultarlos, corregir un registro existente o eliminarlo.
